...
const ship = {
    ...
    "vely": 0,
    "maxShoot": 3,
    "currentShoot": [undefined, undefined, undefined],
    "status": "alive"
};
...
function shoot(interval, i) {
    ...
    } else if ((ship.currentShoot[i]["i"] >= 100) && (ship.currentShoot[i]["i"] <= 120)) {
    ...
    } else if (ship.currentShoot[i]["i"] > 120) {
